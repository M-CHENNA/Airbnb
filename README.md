...
```
git clone https://github.com/M-CHENNA/Airbnb.git
cd Airbnb
```
...
| Membre | Contribution |
|---|---|
| Manel Chenna | 50 % — pipeline dbt, dashboard, documentation (en binôme) |
| Amine Jeribi | 50 % — pipeline dbt, dashboard, documentation (en binôme) |